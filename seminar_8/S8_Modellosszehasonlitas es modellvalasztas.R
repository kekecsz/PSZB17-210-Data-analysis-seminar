...
# Ugy fogjuk a ket modellt felepiteni, hogy az egyszerubb modellben szereplo prediktorok egy reszhalmazat alkotjak a bonyolultabb modell prediktorainak. vagyis a bonyolultabb modell minden prediktort tartalmaz az egyszerubb modellbol, plusz meg nehany extra prediktort. Ezt ugy nevezzuk hogy "nested models" vagyis "egymasba agyazott modellek", hiszen a modellek ugy epulnek fel mint a matrjoska babak.	
...
# Az AIC legtobbszor alkalmas nem beagyazott  modellek osszehasonlitasara is, (bar ezzel kapcsolatban nem teljes az egyetertes a szakirodalomban, a dolgozatokban elfogadott AIC-ot haszna?ni nem beagyazott modellek osszehasonlitasara).	
