...
#"https://raw.githubusercontent.com/kekecsz/PSZB17-210-Data-analysis-seminar-exams/master/ZH-1/pot_ZH_1_20201022.csv"
#
...
# 6. Teszteld a kovetkezokben felsorolt hipoteziseket.
...
#
# Hipotezis 1. A kiserleti csoport tagjainak gyermekeinek magasabb az IQ atlaga, 
# mint a kontrol csoport tagjainak gyermekeinek az IQ atlaga - 5 pont
#
...
#
# 7. Toltsd fel a teljesen megoldott ZH kodjat a hazi feladatokhoz is hasznalt sajat google drive folderedbe. A File neve legyen zh_1_pot_[neved].R (pl. zh_1_pot_kekecszoltan.R)
