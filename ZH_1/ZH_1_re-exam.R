...
# package-eket betoltes elott (az alabbi feladatok a tidyverse es a psych packagekkel megoldhatoak) - 1/1 pont

# 2. töltsd be az adatot erről az URL-ről (ez egy .csv file). - 1/1 pont
# https://raw.githubusercontent.com/kekecsz/PSZB17-210-Data-analysis-seminar-exams/master/ZH-1/epidural_dataset.csv
...
#     Complications - faktor változó, Failure - person got dizzy, Failure - too many OCs,
#             None, Paresthesia, and Wet Tap. Failure - person got dizzy = sikertelen, a pánciens
...
# zh_1_reexam_[neved].R (pl. zh_1_reexam_kekecszoltan.R)