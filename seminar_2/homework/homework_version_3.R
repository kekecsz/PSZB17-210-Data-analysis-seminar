...
# 6.feladat:
## A "titanic_data" adattáblából szűrd ki csak az harmadik osztályon utazókat.
...
# 8.feladat:
## A "Fare" változóban dollárban van a jegyek ára. Mennyibe kerülnének most ezek a jegyek euróban?
## Számold ki (1 dollár = 0.9 euró), és mentsd el egy új változóba "Fare_EUR".