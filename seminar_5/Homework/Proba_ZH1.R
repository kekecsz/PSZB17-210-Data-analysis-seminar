...
#"https://raw.githubusercontent.com/kekecsz/PSZB17-210-Data-analysis-seminar/master/seminar_5/Homework/Proba_ZH1_data.csv"
#
# Olvasd el figyelmesen az adat leirasat, mert az adatok ismerete szukseges az alabbi feladatok megoldasahoz
#
# Az adatbazis egy olyan kutatas szimulalt adatait  tartalmazza ahol kulonbozo kezelesek hatekonysagat 
# teszteltek tulsolyos szemelyeknel annak elosegitesere hogy csokkentsek a testsulyukat. 	
# Valtozok:	
...
# 4. Keszits egy uj valtozot az adattablaban. Ennek az uj valtozonak legyen a neve "psychotherapy" ami 
# azt hivatott jelezni hogy az adott szemely kapott-e pszichoterapias kezelest. 
# Mindenki aki kapott pszichoterapias kezelest (vagyis a treatment_type valtozo szerint "psychotherapy"
# vagy "pill_and_psychotherapy" csoportba tartozik) ezen az uj valtozon vegyen fel "psychotherapy" erteket,
# mindenki mas pedig "no_psychotherapy" erteket. - 1 pont
...
# Ellenorizd, hogy sikerult-e minden hibat amnit talaltal helyesen javitani ez az ellenorzes is 
# szerepeljen a kodban).
# Ha a javitas soran vannak olyan faktorszintek amikbol mar nem marad egy megfigyeles sem, 
# ejtsd ezeket a faktorszinteket a droplevels() funcioval.
# A javitott adatfajlt mentsd el egy uj objektumba, es a kovetkezo lepesekben mar ezzel 
# a javitott adattablaval dolgozz.

# 6. Teszteld az alabb felsorolt hipoteziseket.
# Minden egyes hipotezis eseten eloszor vegezz leiro elemzest a megfelfelo tablazatokkal vagy 
# osszegzo adatokkal. A Leiro elemzesben szerepeljenek abrak is, ahol ez ertelmes.
...
# teszt-statisztika erteke, szabadsagfok, p-ertek, es amikor ez relevans, a hatas meretenek 
# pontbecslese es konfidencia intervalluma.
#
# Hipotezis 1. Van kulonbseg a kezelesi csoportok (treatment_type) kozott a kezeles elotti BMI 
# ertekben - 4 pont
#
# Hipotezis 2. Azoknak a szemelyek, akik pszichoterapias kezelest kaptak ("psychotherapy", 
# "pill_and_psychotherapy") atlagosan alacsonyabb volt a kezeles utani BMI-je mint azoknak,
# akik nem kaptak pszichoterapias kezelest. - 5 p
#
...
# legalabb 30 vagy magasabb) kulonbozik azoknal akik nem kaptak semmilyen kezelest ("no_treatment") 
