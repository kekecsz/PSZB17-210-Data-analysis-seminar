...
# A statisztikai inferencia, es hipotezis teszteles soran az a celunk, hogy megallapitsuk, letezik-e egy bizonyos hatas vagy kapcsolat. De ezt a **null-hipotezis szignifikancia teszteles (NHST)** soran egy forditott logikaval tesszuk: azt allapitjuk meg, hogy **mekkora a valoszinusege hogy az altalunk megfigyelt hatast (vagy annal meg extremebb hatast) kapjunk, amennyiben a null-hipotezis igaz**.	
...
# **Nem kell jonak lennunk valoszinusegszamitasbol** hogy jo statistzikai donteseket tudjunk hozni. A megfigyeles valoszinuseget a null-hipotezis helyesseget feltetelezve altalaban egy **statisztikai teszt** mondja meg nekunk. Ezen az oran negy statisztikai tesztet fogunk megismerni.	
