######################################
# Az 1. gyakorlat gyakorlo script-je #
######################################
...
# 2. vond ki a number1 és a number2 összegéből ezt az objektumot, és az 
# eredményt rendeld hozzá egy result nevű objektumhoz.
