...
# a modellünkre, milyen következményei vannak ha sérülnek ezek az elofeltetelek és mi a teendo ilyenkor.	
...
# Azok a pontok, melyek a diagrammon a regressziós vonal közepéhez közel helyezkednek el kissebb befolyassal	
# vannak arra mint a **végeknél lévoek**. Azok az esetek (megfigyelesek) amelyek nagy reziduális hibaval és nagy	
# befolyással jellemezhetoek, nagy hatast fejtenek ki a modellre. A **Cook távolság** mutatja meg, mekkora egy	
# eset hatasa a modellre.	

# Bár nincs kokrét szabály a problémás esetek meghatározására, de van néhány álltalános alapelv. Vannak akik	
# az **1-nél nagyobb** Cook távolságú értékeket, míg mások a **4/N-nél (ahol N az adatok száma) nagyobb** Cook	
# távolságot tekintik jelentos hatasunak.	

# Esetünkben egyetlen esetben sem nagyobb a Cook távolság 1-nél, néhány esetben azonban 0,02-t már	
# meghaladja. Vagyis a második kirtérium alapján van nehany nagy hatasu eset a mintaban.	

# A nagy hatasu esetek jelenlete onmagaban nem feltetlenul jelent orvosolando problemat, viszont ez konnyen	
# vezethet a regresszios modell **bejoslo erejenek csokkenesehez**, es ahhoz, hogy a regresszio alapfeltetelei	
# megserulnek.	

# Eloször is teszteljük hogy teljesülnek-e a többszörös regresszió elofeltetelei, és csak utána hozzunk dontest	
# azzal kapcslatban, hogy mit kezdunk a nagy hatasu esetekkel.	
...
# Megjegyzendo, hogy itt a modellbol származó elorejelzés hibájáról (rezidualisáról), és nem az egyes prediktorok	
# vagy bejosolt valtozo eloszlásáról beszélünk.	

# Ezt a elofeltetelt egy QQ diagramm (**QQ plot**) ábrázolásával, és az esetek elméleti, diagonálishoz viszonyított	
# elrendezésének vizsgálatával ellenorizhetjük. Ha az esetek jelentosen eltérnek az ábrán szaggatott vonallal	
# jelzett elmeleti diagonálistól, úgy a normalitásra vonatkozó elofeltetel sérülhet.	

# A rezidualisok **hisztogrammját** is érdemes szemügyre vennünk. Ezen egy a normál eloszlásnak megfelelo,	
# Gauss-görbéhez hasonló alakzatot kell látnunk ha a normalitás feltétele teljesül.	

# A **skew és kurtosis** statisztikákat is lekérdezhetjük a describe() függvény segítségével. ha a skew és kurtosis >	
# 1, úgy az a normalitási feltétel sérülését jelezheti.	
...
# Végezzünk modell diagnoztikát a ma tanultak alapján, egy új lineáris modellen, ahol az “sqm_living”,	
# “sqm_living15”, “yr_built”, és “condition” prediktorok alapján határozzuk meg az ingatlan árakat.	
