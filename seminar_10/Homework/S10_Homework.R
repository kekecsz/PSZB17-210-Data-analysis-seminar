...
# 2. Mekkora ennek a modellnek az előrejelzési pontossága? Számold ki azt is,
# hogy a modell mennyire volt pontos a valójában szívbetegségben szenvedők
# és a valójában szívbetegségben nem szenvedők kategorizálásában csoportonként külön.

# 3. A kórház, ahol dolgozol szeretné maximalizálni az érzékenységet a 
# szívbetegség kimutatására. Szeretnék elérni a 85%-os pontosságot a szívbetegség
# helyes felismerésében. Finomhangold a küszöbértéket, amely alapján egy esetet 
# szívbetegségnek minősítünk, hogy legalább 85%-os pontosságot érj el a 
# szívbetegség helyes felismerésében (azok között akinek valóban szívbetegsége van).
# Ezzel a módosítással mekkora pontossággal lehet kategorizálni azokat az eseteket, 
# amelyekben valójában nincs szívbetegség?

# 4. A modelled regressziós egyenlete alapján mekkora a valószínűsége(!) annak, 
# hogy egy személynek szívbetegsége van, ha az adott személy max_HR értéke 165 
# és sys_bloodpressure értéke 190, és mellkasi fájdalmai is vannak?
