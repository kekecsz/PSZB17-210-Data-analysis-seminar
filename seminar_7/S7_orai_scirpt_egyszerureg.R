...
# cipomeret = intercept_b + magassag_b * magassag	
...
# Ez azt jelenti, hogy a prediktorok figyelembevetelevel (a mi esetunkben ez a magassag), a cipomeret valtozekonysaganak (R^2*100)%-at tudjuk megmagyarazni. 	
