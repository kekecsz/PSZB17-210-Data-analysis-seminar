...
# "A tobbszoros regresszios modell mely tartalmazta a lakoterulet es a lakas minosites prediktorokat hatekonyabban tudta bejosolni a lakas arat mint a null modell. A modell a lakasar varianciajanak 0.35%-at magyarazta (F (2, 197) =  54.94, p < .001, AIC = 2137.06).
