...
COVID_20200929_ujvaltozok = COVID_20200929 %>%
...
COVID_20200929_ujvaltozok %>% 
  group_by(population_density_kat) %>% 
  summarize(n = n())

table(COVID_20200929_ujvaltozok$population_density_kat)
...
COVID_20200929_ujvaltozok_surunelkul = COVID_20200929_ujvaltozok %>%
  filter(population_density_kat != "suru")

COVID_20200929_ujvaltozok_surunelkul %>% 
  group_by(population_density_kat) %>% 
  summarize(n = n())

table(COVID_20200929_ujvaltozok_surunelkul$population_density_kat)

summary(COVID_20200929_ujvaltozok_surunelkul$population_density_kat)
...
COVID_20200929_ujvaltozok_surunelkul = COVID_20200929_ujvaltozok_surunelkul %>% 
