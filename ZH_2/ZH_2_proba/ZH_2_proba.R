...
# Az elso jelentkezonek 8 eve van phd-ja, es 12 eve van a szakmajaban, jelenleg docens ("AssocProf") egy elmeleti tanszeken ("A")
...
# melyik prediktornak a legkisebb a hozzadott bejoslo ereje?
